...
problem.addConstraint(lambda sti: sti==21, ([nom]))
nom = "st_"+str(0)+"_"+str(1);
problem.addConstraint(lambda sti: sti==31, ([nom]))
nom = "st_"+str(0)+"_"+str(2);
problem.addConstraint(lambda sti: sti==73, ([nom]))
nom = "st_"+str(1)+"_"+str(0);
problem.addConstraint(lambda sti: sti==1, ([nom]))
nom = "st_"+str(1)+"_"+str(1);
problem.addConstraint(lambda sti: sti==51, ([nom]))
nom = "st_"+str(1)+"_"+str(2);
problem.addConstraint(lambda sti: sti==78, ([nom]))
nom = "st_"+str(2)+"_"+str(0);
problem.addConstraint(lambda sti: sti==31, ([nom]))
nom = "st_"+str(2)+"_"+str(1);
problem.addConstraint(lambda sti: sti==56, ([nom]))
nom = "st_"+str(2)+"_"+str(2);
problem.addConstraint(lambda sti: sti==58, ([nom]))
