...
# L'execution est longue beaucoup trop longue ... on verifie 
nom = "st_"+str(0)+"_"+str(0);
problem.addConstraint(lambda sti: sti==1, ([nom]))
nom = "st_"+str(0)+"_"+str(1);
problem.addConstraint(lambda sti: sti==11, ([nom]))
nom = "st_"+str(0)+"_"+str(2);
problem.addConstraint(lambda sti: sti==31, ([nom]))
nom = "st_"+str(1)+"_"+str(0);
problem.addConstraint(lambda sti: sti==52, ([nom]))
nom = "st_"+str(1)+"_"+str(1);
problem.addConstraint(lambda sti: sti==87, ([nom]))
nom = "st_"+str(1)+"_"+str(2);
problem.addConstraint(lambda sti: sti==92, ([nom]))
nom = "st_"+str(2)+"_"+str(0);
problem.addConstraint(lambda sti: sti==36, ([nom]))
nom = "st_"+str(2)+"_"+str(1);
problem.addConstraint(lambda sti: sti==50, ([nom]))
nom = "st_"+str(2)+"_"+str(2);
problem.addConstraint(lambda sti: sti==72, ([nom]))
