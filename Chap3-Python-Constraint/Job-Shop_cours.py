...
problem.addConstraint(lambda sti: sti==0, ([nom]))
nom = "st_"+str(0)+"_"+str(1);
problem.addConstraint(lambda sti: sti==28, ([nom]))
nom = "st_"+str(0)+"_"+str(2);
problem.addConstraint(lambda sti: sti==48, ([nom]))
nom = "st_"+str(1)+"_"+str(0);
problem.addConstraint(lambda sti: sti==0, ([nom]))
nom = "st_"+str(1)+"_"+str(1);
problem.addConstraint(lambda sti: sti==5, ([nom]))
nom = "st_"+str(1)+"_"+str(2);
problem.addConstraint(lambda sti: sti==10, ([nom]))
nom = "st_"+str(2)+"_"+str(0);
problem.addConstraint(lambda sti: sti==9, ([nom]))
